				...
				<div class="col-lg-12">
					<div class="box-content card white">
						...
						<div class="card-content">
							<c:url value="/admin/pages/editBook" var="editBook"/>
							<form action="${editBook}" method="post" enctype = "multipart/form-data">
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<label>Tên sách</label> <input type="text"
												class="form-control" name="name" value="${book.name}" placeholder="Tên sách">
										</div>
										<div class="form-group">
											<label>Tác giả</label> <input type="text"
												class="form-control" name="author" value="${book.author}" placeholder="Tác giả">
										</div>
										<div class="form-group">
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<div>
												<div class="input-group">
													<input type="text" class="form-control" name="releaseDate" value="${book.dateToString()}"
										...
										<div class="form-group">
											<label>Giá thành</label> <input type="text" class="form-control" name="price"  value="${book.price}" placeholder="VND">
										</div>
										<div class="form-group">
											<label>Ghi chú</label>
											<div>
												<textarea class="form-control" id="inp-type-5" name="note"
													placeholder="Viết ghi chú...">${book.note}</textarea>
											</div>
										</div>
