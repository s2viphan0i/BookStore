							...
							<tbody>
								<c:forEach items="${listOrder}" var="order">
									<tr>
										...
										<td class="vertical-align"><c:out value="${order.customer.name}"/></td>
										<td class="vertical-align"><c:out value="${order.status}"/></td>
										<td style="text-align:center">
											<c:url value="/admin/pages/editCategory?id=${order.id}" var="editCategory"/>
											<a href="${editCategory}"><i class="far fa-edit"></i></a>
											<c:url value="/admin/pages/deleteCategory?id=${order.id}" var="deleteCategory"/>
