			...
			<div class="wrap_header">
				...
				<div class="header-icons">
					<a href="#" class="header-wrapicon1 dis-block">
						<img src="../img/icons/icon-header-01.png" class="header-icon1" alt="ICON">
					</a>
					...
					<div class="header-wrapicon2">
						...
						<span class="header-icons-noti">${order.items.size()}</span>
									...
									<c:forEach items="${order.items}" var="item">
										<li class="header-cart-item">
											<div class="header-cart-item-img">
												<img src="<c:url value='/image?fileName=${item.book.image}'/>" alt="IMG">
											</div>
											...
											<div class="header-cart-item-txt">
												...
												<span class="header-cart-item-info">
													${item.quantity} x ${item.currencyFormat()} VND
												</span>
											</div>
										</li>
									</c:forEach>
