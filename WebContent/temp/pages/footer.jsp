...
<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		...
		<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
			...
			<ul>
				<c:forEach items="${listCategories}" var="category">
					<li class="p-b-9"><a href="#" class="s-text7"> ${category.name} </a></li>
				</c:forEach>
			</ul>
		</div>
	...
	<div class="t-center p-l-15 p-r-15">
		<a href="#"> <img class="h-size2" src="../img/icons/paypal.png"
			alt="IMG-PAYPAL">
		</a> <a href="#"> <img class="h-size2" src="../img/icons/visa.png"
			alt="IMG-VISA">
		</a> <a href="#"> <img class="h-size2"
			src="../img/icons/mastercard.png" alt="IMG-MASTERCARD">
		</a> <a href="#"> <img class="h-size2" src="../img/icons/express.png"
			alt="IMG-EXPRESS">
		</a> <a href="#"> <img class="h-size2" src="../img/icons/discover.png"
			alt="IMG-DISCOVER">
		</a>
